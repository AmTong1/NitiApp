  ...
  useEffect(() => {
    const handleUrl = (url: string | null) => {
      ...
      if (url.startsWith('nitismart://')) {
        ...
        const allowedPages: Page[] = ['login', 'home', 'qrcode', 'call', 'repairst', 'notification', 'announcement', 'usermgr', 'profile', 'superadmin', 'settings', 'financial', 'payment', 'paymentDetail', 'chat'];
