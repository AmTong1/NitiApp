...
const Profile: React.FC<Props> = ({ darkMode, onUpdated }) => {
  ...
  const save = async () => {
    try {
      ...
      // --- Validation: เธ•เธฃเธงเธเธชเธญเธเน€เธเธญเธฃเนเนเธ—เธฃเธจเธฑเธเธ—เนเธ•้องครบ 10 หลัก ---
      if (resident) {
        ...
        <View style={[styles.card, { backgroundColor: colors.cardBg, borderColor: colors.line }]}>
          ...
          {loading ? (
            ...
            <>
              ...
              {/* Phone Number - Block non-numeric and 10+ digits */}
              <View style={styles.fieldContainer}>
                ...
                {residentLoading && !resident ? (
                  ...
                  <TextInput
                    value={phone}
                    onChangeText={(text) => {
                      // เธ•รวจสอบ: เธ•เนเธญเธเน€เธเนเธเธ•เธฑเธงเน€เธฅเธเน€เธ—่านั้น และ เธขเธฒเธงเนเธกเนเน€กิน 10 หลัก
                      // เธ–เนเธฒเนเธกเนเนเธเนเน€งื่อนไขนี้ setPhone เธเธฐเนเธกเนเธ–เธนเธเน€รียก เธ—เธณเนเธซเนเธซเธเนเธฒเธเธญเนเธกเนเน€ปลี่ยน (เธเธ”เนเธกเนเธ•เธดเธ”)
